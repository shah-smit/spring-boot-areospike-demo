package com.example.areospikedemo.configuration;
...
public class AerospikeConfiguration {
  ...
  public AerospikeCacheManager cacheManager(AerospikeClient aerospikeClient) {
    AerospikeCacheConfiguration defaultConfiguration = new AerospikeCacheConfiguration(aerospikeConfigurationProperties.getNamespace());
